...
struct ngx_rtmp_live_ctx_s {
	...
	ngx_uint_t							live_type;//http_flv or rtmp_live
	ngx_chain_t *(*prepare_message_pt)(ngx_rtmp_session_t *s, ngx_rtmp_header_t *h, ngx_rtmp_header_t *lh, ngx_chain_t *in);
	ngx_int_t (*send_message_pt)(ngx_rtmp_session_t *s, ngx_chain_t *out, unsigned int priority);
	ngx_int_t (*send_meta_data_pt)(ngx_rtmp_session_t *s, ngx_chain_t *meta_data, unsigned int priority);
